...
Today we implement the ability to update records that exist in our database.

Also, the Code 301 final exam will become available tomorrow and is due at the end of lab time tomorrow. This exam also serves as the Code 401 entrance exam. However, it is a pass/fail graded portion of this course, regardless of your intent to advance to a Code 401 course.
